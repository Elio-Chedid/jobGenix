...
public class AdapterFetchedEoD extends RecyclerView.Adapter<AdapterFetchedEoD.viewHolder> {
    Context ctx;
    ArrayList<Fetched> fetcheds;
    public AdapterFetchedEoD(Context ctx, ArrayList<Fetched> fetcheds){
        this.ctx=ctx;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(ctx).inflate(R.layout.view_all_fetched_jobs,parent,false);
        return new viewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterFetchedEoD.viewHolder holder, int position) {
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        TextView txtJtitle,txtJdesc,txtCname;
        Button btnAccept;
